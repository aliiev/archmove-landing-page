  ...
  <section id="consultation" className="py-6 md:py-8 lg:py-12">
    <div className="container flex flex-col md:flex-row items-center gap-6 md:gap-16 lg:gap-32 mx-auto px-6 md:px-12 2xl:px-32">
      ...
      <div className="w-full">
        <h2 className="text-3xl lg:text-4xl 2xl:text-5xl text-black font-serif font-extralarge leading-tight">Realize your dream <br className="hidden md:block" /> with <span className="text-primary">Archmove</span></h2>
